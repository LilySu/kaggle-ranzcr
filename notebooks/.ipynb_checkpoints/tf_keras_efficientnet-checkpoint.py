# Copied and modified from: https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/keras/applications/efficientnet.py
...
from tensorflow.python.keras import layers  # modified
